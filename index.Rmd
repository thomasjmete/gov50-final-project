...
ms3_data <- total |>
  filter(season %in% c("2021", "2022", "2023"), home_team %in% c("Edmonton Oilers", "Montreal Canadiens", "Calgary Flames", "Toronto Maple Leafs", "Winnipeg Jets", "Vancouver Canucks","Ottawa Senators"))
...
ms3 <- ggplot(data = ms3_data, mapping = aes(
  ...
  fill = home_team)) +
    ...
    labs( 
    title = "NHL Home Team Analysis (Regular Season)",
    x = "Number of Goals Scored by Home Team",
    y = "Performance Score of Home Team",
    subtitle = "A Relationship Between Goals and Performance",
